...
describe('useModelControls', () => {
  ...
  it('session-scopes an active primary-session picker change without rewriting the profile default', async () => {
    ...
    // Composer picks are experiments for this conversation. Settings owns the
