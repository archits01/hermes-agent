...
export default function SystemPage() {
  ...
  const applyUpdate = async () => {
    ...
    if (status?.can_update_hermes === false) {
      showToast(
        "OpenComputer updates are managed outside this dashboard.",
        "success",
      );
      return;
    }
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 py-4">
            ...
            <ConfirmDialog
              ...
              title="Restore full OpenComputer backup?"
              description={`This will overwrite your current OpenComputer configuration, skills, sessions, and data with the contents of ${backupImportLabel(importConfirmTarget)}. This cannot be undone.`}
              destructive
