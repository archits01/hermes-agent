...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateHermes: "OpenComputer aktualisieren",
    updatingHermes: "OpenComputer wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "OpenComputer-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `hermes plugins`).",
  ...
  skills: {
    wisdom: {
      ...
      noDrafts: 'Keine aktiven Beitragsentwürfe oder Einreichungen.',
      ...
      refreshShared: 'Geteilte Skills aktualisieren',
      ...
      updateModeDefault: 'Organisationsstandard verwenden',
      updateModeManual: 'Manuell',
      updateModeAutomatic: 'Automatisch mit Benachrichtigung',
      updateModeRequired: 'Erforderlich',
      updateModeHelp:
        'Gateway wendet die aktuelle Richtlinie Ihrer Organisation an. Sicherheitsrelevante Änderungen erfordern weiterhin Ihre Zustimmung.',
      updateModePlan: mode => `Zukünftige Updates: ${mode}`,
      ...
      updateAvailable: version => (version ? `Update v${version} verfügbar` : 'Update verfügbar'),
      reviewUpdate: 'Update prüfen',
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die OpenComputer nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare OpenComputer-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "OpenComputer-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze OpenComputer mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald OpenComputer ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "OpenComputer scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
