...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "OpenComputer-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `hermes plugins` paritás).",
  ...
  skills: {
    wisdom: {
      ...
      loading: 'Kollektív tudás betöltése',
      unavailable: 'A Kollektív tudás nem érhető el.',
      setup: 'A Kollektív tudás nincs beállítva ehhez a profilhoz.',
      setupDisclosure:
        'A jelöltek minősítése ebben a profilban marad. A Gateway csak a tulajdonos által jóváhagyott privát piszkozat tartalmát, a szerzői szöveget, a deklaratív jegyzék metaadatait és a felügyelt telepítés állapotát kapja meg.',
      setupAction: 'Értem — profil beállítása',
      settingUp: 'Beállítás…',
      scanLocal: 'Helyi készségek vizsgálata',
      ...
      draftState: state => {
        const labels: Record<string, string> = {
          vetting: 'Szerveres ellenőrzés folyamatban',
          ready: 'Áttekintésre kész',
          owner_approved: 'Általad jóváhagyva',
          publishing: 'Közzététel',
          pending_moderation: 'A közösségi rendszergazda jóváhagyására vár',
          changes_requested: 'Módosításokat kértek'
        }
        return labels[state] || state.replaceAll('_', ' ')
      },
      serverScanPassed: 'szerveres vizsgálat sikeres',
      noDescription: 'Nincs a tulajdonos által írt leírás.',
      managedInstalls: 'felügyelt telepítés',
      close: 'Bezárás',
      readEvery: 'Olvass el minden nyers fájlt. A jóváhagyás az alábbi három pontos kivonathoz kötődik.',
      editReview:
        'Itt szerkesztheted a leírást, a SKILL.md fájlt vagy a deklaratív jegyzéket. A mentés új privát változatot hoz létre, újra lefuttatja a vizsgálatokat és új kivonatokat ad; a helyi forráskészséget nem írja át.',
      unsavedChanges: 'Ezeket a módosításokat még nem vizsgáltuk. Jóváhagyás előtt mentsd és vizsgáld újra.',
      saveAndRescan: 'Módosítások mentése és újravizsgálata',
      savingRevision: 'Mentés és újravizsgálat…',
      resetChanges: 'Szerkesztések elvetése',
      reviewedHashes: 'A szerver által jelenleg ellenőrzött változat kivonatai',
      prepareTitle: 'Helyi csomag áttekintése feltöltés előtt',
      prepareNotice:
        'Ezek a mezők ebben a profilban maradnak, amíg kifejezetten el nem küldöd őket a tulajdonos privát szerveres ellenőrzésére. A helyi minősítési számok és indokok soha nem kerülnek bele.',
      ownerDescription: 'Tulajdonos által írt leírás',
      ...
      decline: 'Elutasítás',
      checkUpdates: count => `Frissítések keresése${count ? ` (${count})` : ''}`,
      checking: 'Ellenőrzés…',
      refreshShared: 'Megosztott készségek frissítése',
      ...
      updateModeDefault: 'Szervezeti alapértelmezés használata',
      updateModeManual: 'Kézi',
      updateModeAutomatic: 'Automatikus értesítéssel',
      updateModeRequired: 'Kötelező',
      updateModeHelp:
        'A Gateway a szervezet aktuális szabályzatát alkalmazza. A biztonságérzékeny változások továbbra is jóváhagyást igényelnek.',
      updateModePlan: mode => `Jövőbeli frissítések: ${mode}`,
      activityReady: count => `${count} új értesítés`,
      decisionPublished: skill => `${skill} jóváhagyva, és mostantól meg van osztva a csapatoddal.`,
      decisionChanges: skill => `${skill} megosztás előtt módosítást igényel.`,
      ...
      takedownNotice: skill => `${skill} eltávolítva a közösségből.`,
      markSeen: 'Összes megjelölése olvasottként',
      install: 'Telepítés…',
      uninstall: 'Eltávolítás…',
      checkSkill: 'Készség ellenőrzése',
      updateAvailable: version => (version ? `v${version} frissítés érhető el` : 'Frissítés érhető el'),
      reviewUpdate: 'Frissítés áttekintése',
      installed: (version, mode) => `Telepítve v${version} · ${mode}`,
      confirmAction: action => `${action} megerősítése`,
      acceptCompatibility: 'Áttekintettem és elfogadom a kompatibilitási műveleteket.',
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet az OpenComputert",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
