...
export const ja: Translations = {
  ...
  skills: {
    wisdom: {
      ...
      managedInstalls: '件の管理対象インストール',
      close: '閉じる',
      readEvery: '下記のすべての生ファイルを確認してください。承認は表示された正確な3つのハッシュに紐づきます。',
      editReview:
      ...
      prepareNotice:
        '所有者限定のサーバーレビューに明示的に提出するまで、これらの項目はこのプロファイルに保持されます。ローカルの適格性の回数や理由は含まれません。',
