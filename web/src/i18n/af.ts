...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateHermes: "Werk OpenComputer op",
    updatingHermes: "Besig om OpenComputer op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk OpenComputer-inproppe op (`hermes plugins` ekwivalent).",
  ...
  skills: {
    wisdom: {
      ...
      loading: 'Kollektiewe Wysheid laai',
      unavailable: 'Kollektiewe Wysheid is nie beskikbaar nie.',
      setup: 'Kollektiewe Wysheid is nie vir hierdie profiel opgestel nie.',
      setupDisclosure:
        'Kandidaatkwalifikasie bly op hierdie profiel. Slegs privaat konsepinhoud wat deur die eienaar goedgekeur is, outeurteks, verklarende manifesmetadata en bestuurde installasiestatus bereik die Gateway.',
      setupAction: 'Ek verstaan — stel hierdie profiel op',
      settingUp: 'Word opgestel…',
      scanLocal: 'Skandeer plaaslike vaardighede',
      search: 'Soek gedeelde vaardighede…',
      potential: 'Voorgestelde bydraes',
      potentialHelp:
        'Vaardighede wat Hermes plaaslik gekwalifiseer het op grond van gebruik of betekenisvolle verfyning. Niks word gedeel voordat jy dit hersien nie.',
      noSuggestions: 'Geen plaaslike vaardighede voldoen tans aan die outomatiese kwalifikasiereëls nie.',
      browseLocal: count => `Bekyk alle plaaslike vaardighede (${count})`,
      browseLocalHelp:
        'Handmatige keuse beteken nie dat Hermes hierdie vaardighede gebruik of outomaties gekwalifiseer het nie.',
      ownerReview: 'Jou bydraekonsepte',
      ownerReviewHelp: 'Konsepte wat op jou hersiening wag en indienings wat op kollektiewe goedkeuring wag.',
      noDrafts: 'Geen aktiewe bydraekonsepte of indienings nie.',
      prepare: 'Begin bydrae',
      ...
      draftState: state => {
        const labels: Record<string, string> = {
          vetting: 'Bedienerhersiening is aan die gang',
          ready: 'Gereed vir jou hersiening',
          owner_approved: 'Deur jou goedgekeur',
          publishing: 'Word gepubliseer',
          pending_moderation: 'Wag op goedkeuring deur die kollektief-administrateur',
          changes_requested: 'Veranderinge versoek'
        }
        return labels[state] || state.replaceAll('_', ' ')
      },
      serverScanPassed: 'bedienerskandering geslaag',
      noDescription: 'Geen beskrywing deur die eienaar nie.',
      managedInstalls: 'bestuurde installasies',
      close: 'Sluit',
      readEvery: 'Lees elke rou lêer. Goedkeuring is aan die presiese drie hutswaardes hieronder gebind.',
      editReview:
        'Wysig die beskrywing, SKILL.md of verklarende manifes hier. Stoor skep ’n nuwe privaat hersiening, voer skanderings weer uit en lewer nuwe hutswaardes; dit herskryf nie jou plaaslike bronvaardigheid nie.',
      unsavedChanges: 'Hierdie veranderinge is nog nie geskandeer nie. Stoor en skandeer weer voor goedkeuring.',
      saveAndRescan: 'Stoor veranderinge en skandeer weer',
      savingRevision: 'Word gestoor en weer geskandeer…',
      resetChanges: 'Gooi wysigings weg',
      reviewedHashes: 'Hutswaardes vir die hersiening wat tans deur die bediener nagegaan is',
      prepareTitle: 'Hersien plaaslike pakket voor oplaai',
      prepareNotice:
        'Hierdie velde bly op hierdie profiel totdat jy dit uitdruklik vir ’n privaat bedienerhersiening deur die eienaar indien. Plaaslike kwalifikasietellings en -redes word nooit ingesluit nie.',
      ownerDescription: 'Beskrywing deur die eienaar',
      ...
      decline: 'Weier',
      checkUpdates: count => `Kyk vir opdaterings${count ? ` (${count})` : ''}`,
      checking: 'Word nagegaan…',
      refreshShared: 'Verfris gedeelde vaardighede',
      refreshingShared: 'Word verfris…',
      installReferenceLabel: "Installeer vanaf 'n skakel of vaardigheid-ID",
      installReferencePlaceholder: "Plak 'n Portal-skakel, vaardigheid-ID of skill-id@vN",
      installReferenceHelp: "Hermes verifieer die presiese weergawe en wys 'n versoenbaarheidsplan voor installasie.",
      reviewInstall: 'Hersien installasie',
      planningInstall: 'Word geverifieer…',
      updateModeLabel: 'Toekomstige opdaterings',
      updateModeDefault: 'Gebruik organisasie se verstek',
      updateModeManual: 'Handmatig',
      updateModeAutomatic: 'Outomaties met kennisgewing',
      updateModeRequired: 'Vereis',
      updateModeHelp:
        'Gateway pas jou organisasie se huidige beleid toe. Veiligheidsensitiewe veranderings vereis steeds jou goedkeuring.',
      updateModePlan: mode => `Toekomstige opdaterings: ${mode}`,
      activityReady: count => `${count} nuwe ${count === 1 ? 'kennisgewing' : 'kennisgewings'}`,
      decisionPublished: skill => `${skill} is goedgekeur en word nou met jou span gedeel.`,
      decisionChanges: skill => `${skill} benodig veranderinge voordat dit gedeel kan word.`,
      decisionDeclined: skill => `${skill} is nie vir deling goedgekeur nie.`,
      ...
      takedownNotice: skill => `${skill} is uit die kollektief verwyder.`,
      markSeen: 'Merk alles as gelees',
      install: 'Installeer…',
      uninstall: 'Deïnstalleer…',
      checkSkill: 'Gaan hierdie vaardigheid na',
      updateAvailable: version => (version ? `v${version}-opdatering beskikbaar` : 'Opdatering beskikbaar'),
      reviewUpdate: 'Hersien opdatering',
      installed: (version, mode) => `Geïnstalleer v${version} · ${mode}`,
      confirmAction: action => `Bevestig ${action}`,
      acceptCompatibility: 'Ek het die versoenbaarheidsaksies nagegaan en aanvaar dit.',
  ...
  env: {
    ...
    customHint: "Arbitrêre omgewingsveranderlikes wat in jou .env gestoor is en wat OpenComputer nie herken nie. Gebruik dit om omgewingsveranderlikes vir vaardighede, MCP-bedieners of jou eie gereedskap in te spuit.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare OpenComputer-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "OpenComputer-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik OpenComputer meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra OpenComputer 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "OpenComputer skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
