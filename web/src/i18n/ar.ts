...
export const ar = defineLocale({
  ...
  status: {
    ...
    updatingHermes: "جاري تحديث OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "اكتشف وثبِّت وفعِّل وحدِّث مكوِّنات OpenComputer الإضافية (مطابقة `hermes plugins`).",
  ...
  skills: {
    wisdom: {
      ...
      managedInstalls: 'تثبيتات مُدارة',
      close: 'إغلاق',
      readEvery: 'اقرأ كل ملف خام. ترتبط الموافقة بقيم التجزئة الثلاث الدقيقة المعروضة أدناه.',
      editReview:
      ...
      prepareNotice:
        'تبقى هذه الحقول في هذا الملف الشخصي حتى ترسلها صراحةً لمراجعة خادم خاصة بالمالك. لا يتم تضمين أعداد التأهيل المحلية أو أسبابه أبداً.',
      ...
      decline: 'رفض',
      checkUpdates: (count: number) => `التحقق من التحديثات${count ? ` (${count})` : ''}`,
      ...
      activityReady: (count: number) => `${count} من الإشعارات الجديدة`,
      decisionPublished: (skill: string) => `تمت الموافقة على ${skill} وأصبحت مشتركة مع فريقك.`,
      decisionChanges: (skill: string) => `تحتاج ${skill} إلى تغييرات قبل مشاركتها.`,
      decisionDeclined: (skill: string) => `لم تتم الموافقة على مشاركة ${skill}.`,
      ...
      takedownNotice: (skill: string) => `تمت إزالة ${skill} من المجموعة.`,
      markSeen: 'تعليم الكل كمقروء',
      install: 'تثبيت…',
      uninstall: 'إلغاء التثبيت…',
      checkSkill: 'التحقق من هذه المهارة',
      updateAvailable: (version?: number) => (version ? `يتوفر التحديث v${version}` : 'يتوفر تحديث'),
      reviewUpdate: 'مراجعة التحديث',
      installed: (version: number, mode: string) => `مثبتة v${version} · ${mode}`,
      confirmAction: (action: string) => `تأكيد ${action}`,
  ...
  achievements: {
    hero: {
      ...
      title: "إنجازات OpenComputer",
      subtitle:
        "شارات OpenComputer قابلة للجمع مكتسبة من سجل الجلسات الفعلي. الإنجازات غير المكتملة المعروفة تُعرض كـ Discovered؛ تبقى الإنجازات السرية مخفية حتى يظهر السلوك المطابق لأول مرة.",
      scan_subtitle:
        "فحص سجل جلسات OpenComputer. يمكن أن يستغرق الفحص الأول 5–10 ثوانٍ على السجلات الكبيرة.",
    },
    actions: {
      rescan: "إعادة الفحص",
    },
    stats: {
      ...
      latest: "الأحدث",
      latest_hint_empty: "شغِّل OpenComputer أكثر",
    ...
    guide: {
      ...
      secret_body:
        "تخفى الأسرار محددها الدقيق. بمجرد أن ترى OpenComputer إشارة ذات صلة، تصبح البطاقة مكتشفة وتعرض متطلباتها.",
      scan_status_header: "حالة الفحص",
      scan_status_body:
        "تُفحص OpenComputer السجل المحلي مرة واحدة، ثم تظهر البطاقات تلقائيًا. لا يوجد توقف إذا استغرق هذا بضع ثوانٍ.",
    ...
    share: {
      ...
      tweet_text: "فتحت للتو {tier_part}\"{name}\" في OpenComputer Agent ☤"
    },
  },
