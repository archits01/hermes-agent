...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateHermes: "Nuashonraigh OpenComputer",
    updatingHermes: "Ag nuashonrú OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins OpenComputer (paireacht le `hermes plugins`).",
  ...
  skills: {
    wisdom: {
      ...
      loading: 'Eagna Chomhchoiteann á lódáil',
      unavailable: 'Níl Eagna Chomhchoiteann ar fáil.',
      setup: 'Níl Eagna Chomhchoiteann socraithe don phróifíl seo.',
      setupDisclosure:
        'Fanann cáiliú iarrthóirí ar an bpróifíl seo. Ní shroicheann an Gateway ach ábhar dréachta príobháidí atá ceadaithe ag an úinéir, cóip an údair, meiteashonraí dearbhaitheacha an fhorógra agus staid na suiteálacha bainistithe.',
      setupAction: 'Tuigim — socraigh an phróifíl seo',
      settingUp: 'Á shocrú…',
      scanLocal: 'Scan scileanna áitiúla',
      ...
      noDrafts: 'Níl aon dréachtaí ná aighneachtaí ranníocaíochta gníomhacha ann.',
      ...
      draftState: state => {
        const labels: Record<string, string> = {
          vetting: 'Athbhreithniú an fhreastalaí ar siúl',
          ready: 'Réidh le haghaidh d’athbhreithnithe',
          owner_approved: 'Ceadaithe agat',
          publishing: 'Á fhoilsiú',
          pending_moderation: 'Ag fanacht le ceadú ó riarthóir an chomhchoitinn',
          changes_requested: 'Athruithe iarrtha'
        }
        return labels[state] || state.replaceAll('_', ' ')
      },
      serverScanPassed: 'd’éirigh le scanadh an fhreastalaí',
      noDescription: 'Níl cur síos scríofa ag an úinéir.',
      managedInstalls: 'suiteálacha bainistithe',
      close: 'Dún',
      readEvery: 'Léigh gach comhad amh. Tá an ceadú ceangailte leis na trí hais bheachta thíos.',
      editReview:
        'Cuir an cur síos, SKILL.md nó an forógra dearbhaitheach in eagar anseo. Cruthaíonn sábháil leasú príobháideach nua, ritheann sé na scantaí arís agus tugann sé hais nua ar ais; ní athscríobhann sé do bhunscil áitiúil.',
      unsavedChanges: 'Níor scanadh na hathruithe seo. Sábháil agus scan arís sula gceadaíonn tú.',
      saveAndRescan: 'Sábháil athruithe agus scan arís',
      savingRevision: 'Á shábháil agus á scanadh arís…',
      resetChanges: 'Caith na hathruithe amach',
      reviewedHashes: 'Hais an leasaithe atá athbhreithnithe ag an bhfreastalaí faoi láthair',
      prepareTitle: 'Athbhreithnigh an pacáiste áitiúil roimh uaslódáil',
      prepareNotice:
        'Fanann na réimsí seo ar an bpróifíl seo go dtí go gcuireann tú isteach iad go sainráite le haghaidh athbhreithniú príobháideach freastalaí don úinéir. Ní chuirtear comhairimh ná cúiseanna cáiliúcháin áitiúla san áireamh riamh.',
      ownerDescription: 'Cur síos scríofa ag an úinéir',
      ...
      decline: 'Diúltaigh',
      checkUpdates: count => `Seiceáil nuashonruithe${count ? ` (${count})` : ''}`,
      checking: 'Á sheiceáil…',
      refreshShared: 'Athnuaigh scileanna comhroinnte',
      refreshingShared: 'Á athnuachan…',
      ...
      updateModeDefault: 'Úsáid réamhshocrú na heagraíochta',
      updateModeManual: 'De láimh',
      updateModeAutomatic: 'Uathoibríoch le fógra',
      updateModeRequired: 'Riachtanach',
      updateModeHelp:
        'Cuireann Gateway polasaí reatha d’eagraíochta i bhfeidhm. Teastaíonn do chead fós le haghaidh athruithe slándála-íogaire.',
      updateModePlan: mode => `Nuashonruithe amach anseo: ${mode}`,
      activityReady: count => `${count} fógra nua`,
      decisionPublished: skill => `Ceadaíodh ${skill} agus tá sé roinnte le d’fhoireann anois.`,
      decisionChanges: skill => `Teastaíonn athruithe ar ${skill} sular féidir é a roinnt.`,
      ...
      takedownNotice: skill => `Baineadh ${skill} den chomhchoiteann.`,
      markSeen: 'Marcáil gach ceann léite',
      install: 'Suiteáil…',
      uninstall: 'Díshuiteáil…',
      checkSkill: 'Seiceáil an scil seo',
      updateAvailable: version => (version ? `Nuashonrú v${version} ar fáil` : 'Nuashonrú ar fáil'),
      reviewUpdate: 'Athbhreithnigh an nuashonrú',
      installed: (version, mode) => `Suiteáilte v${version} · ${mode}`,
      confirmAction: action => `Deimhnigh ${action}`,
      acceptCompatibility: 'D’athbhreithnigh mé na gníomhartha comhoiriúnachta agus glacaim leo.',
  ...
  env: {
    ...
    customHint: "Athróga timpeallachta treallach atá stóráilte i do .env nach n-aithníonn OpenComputer. Úsáid iad chun athróga timpeallachta a instealladh do scileanna, freastalaithe MCP, nó d'uirlisí féin.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Suaitheantais OpenComputer inbhailithe a thuilltear ó stair fíor-session. Léirítear gnóthachtálacha aitheanta neamhchríochnaithe mar Discovered; fanann gnóthachtálacha Secret i bhfolach go dtí go bhfeictear an chéad iompar comhoiriúnach.",
      scan_subtitle:
        "Stair session OpenComputer á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    },
    actions: {
      rescan: "Athscan",
    },
    stats: {
      ...
      latest_hint_empty: "rith OpenComputer níos mó",
    ...
    guide: {
      ...
      secret_body:
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann OpenComputer comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",
      scan_status_header: "Stádas an scanta",
      scan_status_body:
        "Scanann OpenComputer an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
