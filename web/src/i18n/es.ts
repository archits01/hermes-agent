...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateHermes: "Actualizar OpenComputer",
    updatingHermes: "Actualizando OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de OpenComputer (equivalente a `hermes plugins`).",
  ...
  skills: {
    wisdom: {
      ...
      potential: 'Contribuciones sugeridas',
      potentialHelp:
        'Habilidades que Hermes ha calificado localmente por su uso o mejoras significativas. No se comparte nada hasta que lo revises.',
      noSuggestions: 'Actualmente ninguna habilidad local cumple las reglas de calificación automática.',
      browseLocal: count => `Ver todas las habilidades locales (${count})`,
      browseLocalHelp:
        'La selección manual no significa que Hermes haya usado o calificado automáticamente estas habilidades.',
      ownerReview: 'Tus borradores de contribución',
      ownerReviewHelp: 'Borradores pendientes de tu revisión y envíos pendientes de aprobación colectiva.',
      noDrafts: 'No hay borradores ni envíos de contribución activos.',
      ...
      refreshShared: 'Actualizar habilidades compartidas',
      refreshingShared: 'Actualizando…',
      installReferenceLabel: 'Instalar desde un enlace o ID de habilidad',
      installReferencePlaceholder: 'Pega un enlace del Portal, un ID de habilidad o skill-id@vN',
      installReferenceHelp: 'Hermes verifica la versión exacta y muestra un plan de compatibilidad antes de instalar.',
      reviewInstall: 'Revisar instalación',
      planningInstall: 'Verificando…',
      updateModeLabel: 'Actualizaciones futuras',
      updateModeDefault: 'Usar el valor predeterminado de la organización',
      updateModeManual: 'Manual',
      updateModeAutomatic: 'Automática con aviso',
      updateModeRequired: 'Obligatoria',
      updateModeHelp:
        'Gateway aplica la política actual de tu organización. Los cambios sensibles para la seguridad siguen requiriendo tu aprobación.',
      updateModePlan: mode => `Actualizaciones futuras: ${mode}`,
      ...
      updateAvailable: version => (version ? `Actualización v${version} disponible` : 'Actualización disponible'),
      reviewUpdate: 'Revisar actualización',
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que OpenComputer no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de OpenComputer ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de OpenComputer. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa OpenComputer más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que OpenComputer detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "OpenComputer está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
