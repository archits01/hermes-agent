...
export const en: Translations = {
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      "This restarts the OpenComputer gateway process. Connected channels and active sessions will reconnect afterward.",
    ...
    updateHermesConfirmTitle: "Update OpenComputer?",
    updatingHermes: "Updating OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update OpenComputer plugins (`hermes plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that OpenComputer doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible OpenComputer badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning OpenComputer session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run OpenComputer more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once OpenComputer sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "OpenComputer is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
